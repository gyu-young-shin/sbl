...
.dlls,er4ft .dlls: sbl.per4ft

-include package/cfg/sbl_per4ft.mak
-include package/cfg/sbl_per4ft.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/sbl_per4ft.dep
endif
sbl.per4ft: package/cfg/sbl_per4ft.xdl
	@


ifeq (,$(wildcard .libraries,er4ft))
sbl.per4ft package/cfg/sbl_per4ft.c: .libraries,er4ft
endif

package/cfg/sbl_per4ft.c package/cfg/sbl_per4ft.h package/cfg/sbl_per4ft.xdl: override _PROG_NAME := sbl.xer4ft
package/cfg/sbl_per4ft.c package/cfg/sbl_per4ft.xdl: override _PROG_XSOPTS = -DMMWAVE_SDK_DEVICE_TYPE=xwr68xx
package/cfg/sbl_per4ft.c: package/cfg/sbl_per4ft.cfg
package/cfg/sbl_per4ft.xdc.inc: package/cfg/sbl_per4ft.xdl
package/cfg/sbl_per4ft.xdl package/cfg/sbl_per4ft.c: .interfaces

clean:: clean,er4ft
	-$(RM) package/cfg/sbl_per4ft.cfg
	-$(RM) package/cfg/sbl_per4ft.dep
	-$(RM) package/cfg/sbl_per4ft.c
	-$(RM) package/cfg/sbl_per4ft.xdc.inc

clean,er4ft::
	-$(RM) sbl.per4ft
.executables,er4ft .executables: sbl.xer4ft

sbl.xer4ft: |sbl.per4ft

-include package/cfg/sbl.xer4ft.mak
sbl.xer4ft: package/cfg/sbl_per4ft.oer4ft 
	$(RM) $@
	@$(MSG) lnker4ft $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.R4Ft.rootDir)/bin/armlnk -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7R4 --strict_compatibility=on  -o $@ package/cfg/sbl_per4ft.oer4ft   package/cfg/sbl_per4ft.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.R4Ft.rootDir)/lib/libc.a
	
sbl.xer4ft: export C_DIR=
sbl.xer4ft: PATH:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)
sbl.xer4ft: Path:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)

sbl.test test,er4ft test: sbl.xer4ft.test

sbl.xer4ft.test:: sbl.xer4ft
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 sbl.xer4ft.test
else
	@$(MSG) running $<  ...
	$(call EXEC.sbl.xer4ft, ) 
endif

clean,er4ft::
	-$(RM) $(wildcard .tmp,sbl.xer4ft,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
sbl_per4ft.oer4ft,copy : package/cfg/sbl_per4ft.oer4ft
sbl_per4ft.ser4ft,copy : package/cfg/sbl_per4ft.ser4ft
