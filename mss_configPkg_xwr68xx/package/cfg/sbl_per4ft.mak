...
#
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/sbl_per4ft.oer4ft.dep
package/cfg/sbl_per4ft.oer4ft.dep: ;
endif

package/cfg/sbl_per4ft.oer4ft: | .interfaces
package/cfg/sbl_per4ft.oer4ft: package/cfg/sbl_per4ft.c package/cfg/sbl_per4ft.mak
	@$(RM) $@.dep
	$(RM) $@
	@$(MSG) cler4ft $< ...
	$(ti.targets.arm.elf.R4Ft.rootDir)/bin/armcl -c  --enum_type=int -qq -pdsw225 -ms --fp_mode=strict --code_state=16 --float_support=vfpv3d16 --endian=little -mv7R4 --abi=eabi -eo.oer4ft -ea.ser4ft   -Dxdc_cfg__xheader__='"mss_configPkg_xwr68xx/package/cfg/sbl_per4ft.h"'  -Dxdc_target_name__=R4Ft -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_16_9_6 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.R4Ft.rootDir)/include  -fs=./package/cfg -fr=./package/cfg -fc $<
...
package/cfg/sbl_per4ft.oer4ft: export C_DIR=
package/cfg/sbl_per4ft.oer4ft: PATH:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)
package/cfg/sbl_per4ft.oer4ft: Path:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)

package/cfg/sbl_per4ft.ser4ft: | .interfaces
package/cfg/sbl_per4ft.ser4ft: package/cfg/sbl_per4ft.c package/cfg/sbl_per4ft.mak
	@$(RM) $@.dep
	$(RM) $@
	@$(MSG) cler4ft -n $< ...
...
package/cfg/sbl_per4ft.ser4ft: export C_DIR=
package/cfg/sbl_per4ft.ser4ft: PATH:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)
package/cfg/sbl_per4ft.ser4ft: Path:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)

clean,er4ft ::
	-$(RM) package/cfg/sbl_per4ft.oer4ft
	-$(RM) package/cfg/sbl_per4ft.ser4ft

sbl.per4ft: package/cfg/sbl_per4ft.oer4ft package/cfg/sbl_per4ft.mak

clean::
	-$(RM) package/cfg/sbl_per4ft.mak
